...
class Van(models.Model):
    ...
    branch_id = models.ForeignKey('master.BranchMaster', on_delete=models.SET_NULL, null=True, blank=True,related_name='van_branch',limit_choices_to={'user_type': 'Branch User'})

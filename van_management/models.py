...
class Van(models.Model):
    ...
    driver = models.ForeignKey('accounts.CustomUser', on_delete=models.SET_NULL, null=True, blank=True, related_name='driver_van', limit_choices_to={'usertype': 'Driver'})
    salesman = models.ForeignKey('accounts.CustomUser', on_delete=models.SET_NULL, null=True, blank=True, related_name='salesman_van', limit_choices_to={'usertype': 'Salesman'})

...
class CustomerSupplyStockAdmin(admin.ModelAdmin):
    list_display = ('product', 'customer', 'stock_quantity')
admin.site.register(CustomerSupplyStock,CustomerSupplyStockAdmin)
